  ...
  return (
    <div className="max-w-[800px] mx-auto px-4 py-8">
      <div className="text-center pt-12 pb-8 max-sm:pt-8 max-sm:pb-6">
        <h1 className="text-[2.25rem] max-sm:text-[1.75rem] font-extrabold text-[#e5e5e5] leading-[1.2] mb-3">
          AI로 내 목소리가
          <br />
          <span className="text-purple-600">이렇게!</span>
        </h1>
        <p className="text-base text-[#888] max-w-[400px] mx-auto">
      ...
      <div className="flex flex-col gap-5 mb-8">
        {DEMO_SAMPLES.map((sample) => (
          <div key={sample.title} className="bg-[#141414] border border-[#2a2a2a] rounded-xl p-5">
            <h3 className="text-base font-semibold text-[#e5e5e5] mb-4">{sample.title}</h3>
            <AudioPlayer
      ...
      <div className="bg-gradient-to-br from-purple-600/15 to-purple-600/5 border border-purple-600/30 rounded-xl p-8 text-center">
        <p className="text-[1.05rem] text-[#e5e5e5] mb-5">
