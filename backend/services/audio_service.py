...
def analyze_audio_file(audio_path: str) -> dict:
    """WAV 파일 분석 → {pitch_values, avg_pitch, tone_stability, duration}"""
    ...
    try:
        ...
        return {"pitch_values": [], "avg_pitch": 0.0, "tone_stability": 0.0, "duration": duration}
    ...
    return {"pitch_values": voiced.tolist(), "avg_pitch": avg_pitch, "tone_stability": tone_stability, "duration": duration}
