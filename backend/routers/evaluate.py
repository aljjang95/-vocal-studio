...
async def evaluate(req: EvaluateRequest):
    ...
    score = calculate_stage_score(float(pitch_accuracy), analysis["tone_stability"], tension_detected)
    ...
    return EvaluateResponse(
        score=score, pitch_accuracy=pitch_accuracy, tone_stability=analysis["tone_stability"],
        tension_detected=tension_detected, feedback=feedback, passed=passed,
    )
